...
export class DbService {
    constructor(private readonly dbHelper: MongoHelper) {
    ...
    /** Returns a set of character names and IDs for a specified user. */
    async getCharactersForUserId(userId: ObjectId, includeAiDescription: boolean): Promise<string[]> {
